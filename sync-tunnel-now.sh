...
echo ""
echo "📋 Next steps:"
echo "1. Update DNS CNAME in IDCloudHost:"
echo "   Name: @"
echo "   Value: $TUNNEL_URL"
echo ""
echo "2. Wait 5-10 minutes for DNS propagate"
echo ""
echo "3. Test: curl https://scafffood.my.id/api/products"
echo ""
