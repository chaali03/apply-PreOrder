                ...
                return (
                  <div key={order.id} className="order-card">
                    ...
                    <div className="order-body">
                      ...
                      {order.order_status === 'completed' && order.appreciation_message && (
                        <div className="order-appreciation">
                          <div className="appreciation-header">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
                            </svg>
                            <strong>Pesan dari SCAFF*FOOD:</strong>
                          </div>
                          <p className="appreciation-message">{order.appreciation_message}</p>
                        </div>
                      )}
